        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><a href="<?php echo base_url("") ?>">About kabinet</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<section id="content">
      <div class="container">
        <div class="row">
          <div class="span6">
            <h3>Kabinet <strong>Harmoni Kolaborasi</strong></h3>
            <p>
          ...
          <div class="span6">
            ...
            <div class="flexslider">
              <ul class="slides">
                <li>
                  <img src="<?php echo base_url() ?>master/img/works/full/image-01-full.jpg" alt="" />
                </li>
                <li>
                  <img src="<?php echo base_url() ?>master/img/works/full/image-02-full.jpg" alt="" />
                </li>
                <li>
                  <img src="<?php echo base_url() ?>master/img/works/full/image-03-full.jpg" alt="" />
                </li>
              </ul>
            </div>
            <!-- end flexslider -->
        ...
        <div class="row">
          ...
          <div class="span3">
            <img src="<?php echo base_url() ?>master/img/dummies/team1.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="<?php echo base_url() ?>master/img/dummies/team2.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="<?php echo base_url() ?>master/img/dummies/team3.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="<?php echo base_url() ?>master/img/dummies/team4.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
